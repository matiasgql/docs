...
<Compare before="/images/AOAlgorithm0.png" after="/images/AOAlgorithm1.png" beforeLabel="Algorithm 0 (GT-VBAO)" afterLabel="Algorithm 1 (HBAO+)" />
...
Enables attenuation of the AO effect inside fog volumes. When enabled, AO fades out in areas affected by fog, producing a more natural look.
...
## Fog Attenuation Amount

Controls the strength of the fog-based AO attenuation. Higher values cause AO to fade out more aggressively inside fog.
