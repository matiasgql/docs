...
## Desenfoque habilitado (Blur Enabled)

Habilita o deshabilita el paso de desenfoque del AO.
...
<Compare before="/images/AOTemporalAccumulation0.png" after="/images/AOTemporalAccumulation1.png" beforeLabel="Fluctuación Temporal 0" afterLabel="Fluctuación Temporal 1" />
...
<Compare before="/images/AOAlgorithm0.png" after="/images/AOAlgorithm1.png" beforeLabel="Algoritmo 0 (GT-VBAO)" afterLabel="Algoritmo 1 (HBAO+)" />

Selecciona el algoritmo de AO. Este ajuste es exclusivo de GT-VBAO.
...
## Atenuación de niebla (Fog Attenuation)

<Compare before="/images/AOFogAttenuation0.png" after="/images/AOFogAttenuation1.png" beforeLabel="Fog Attenuation 0" afterLabel="Fog Attenuation 1" />

Habilita la atenuación del efecto AO dentro de volúmenes de niebla. Cuando está activo, el AO se desvanece en las áreas afectadas por niebla, produciendo un resultado más natural.

`0` — Desactivado `1` — Activado

```text
r.AO.FogAttenuation 1
```

---

## Intensidad de atenuación de niebla (Fog Attenuation Amount)

Controla la fuerza de la atenuación de AO basada en niebla. Valores más altos hacen que el AO se desvanezca más agresivamente dentro de la niebla.

```text
r.AO.FogAttenuation.Amount 1.0
```
